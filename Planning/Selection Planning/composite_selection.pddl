(define (problem maximize-composite-lineup)
  (:domain basketball-lineup-multi-objective)

  ;; Problem: Select a 5-player lineup that fills all positions and maximizes composite score.
  ;; Composite score is defined as the sum of offense, defense, and playmaking for each player.
